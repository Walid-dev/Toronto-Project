                        ...
                        <div class="tab-pane p-4 fade" id="panel8" role="tabpanel">
                            ...
                            <div class="modal-body">
                                <form class="modal_form" action="index.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <button id="validate" type="submit" class="up btn btn-md btn-info mt-3" name="signup-submit">Créer</button>
                                    </div>
                                </form>
                            </div>
    ...
    <button id="btnLogin" href="" class="up btn btn-md btn-info" data-toggle="modal" data-backdrop="false" data-target="#modalLRForm">Connection</button>