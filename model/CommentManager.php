...
class CommentManager extends Manager
{
    ...
    {
        $db = Manager::dbConnect();
        $comments = $db->prepare('SELECT id, author, comment, report, comment_status, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin\') AS comment_date_fr FROM comments WHERE post_id = ? ORDER BY comment_date DESC');
